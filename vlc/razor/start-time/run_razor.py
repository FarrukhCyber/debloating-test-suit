...
def train():
    ...
    for fname in os.listdir('../train'):
        ...
        # -c
        cmd = BIN + ' ' + '--start-time=' + start_time + ' ' + fpath
...
def test():
    BIN = './vlc.orig_temp/vlc.orig.debloated'
    # test yet to be written
...
def main():
    ...
    if sys.argv[1] == 'train':
        ...
        extend_debloat('vlc', heuristic_level)

    elif sys.argv[1] == "get_test_traces":
        get_traces_for_test("logs", "vlc")
