...
def train():
    # 25
    train_run("""-fullscreen ./train/1.pdf""")

    train_run("""-fullscreen ./train/2.pdf""")

    train_run("""-fullscreen ./train/3.pdf""")

    train_run("""-fullscreen ./train/4.pdf""")

    train_run("""-fullscreen ./train/5.pdf""")

    train_run("""-fullscreen ./train/6.pdf""")

    train_run("""-fullscreen ./train/7.pdf""")

    train_run("""-fullscreen ./train/8.pdf""")

    train_run("""-fullscreen ./train/9.pdf""")

    train_run("""-fullscreen ./train/10.pdf""")

    train_run("""-fullscreen ./train/11.pdf""")

    train_run("""-fullscreen ./train/12.pdf""")

    train_run("""-fullscreen ./train/13.pdf""")

    train_run("""-fullscreen ./train/14.pdf""")

    train_run("""-fullscreen ./train/15.pdf""")

    train_run("""-fullscreen ./train/16.pdf""")

    train_run("""-fullscreen ./train/17.pdf""")

    train_run("""-fullscreen ./train/18.pdf""")

    train_run("""-fullscreen ./train/19.pdf""")

    train_run("""-fullscreen ./train/20.pdf""")

    train_run("""-fullscreen ./train/21.pdf""")

    train_run("""-fullscreen ./train/22.pdf""")

    train_run("""-fullscreen ./train/23.pdf""")

    train_run("""-fullscreen ./train/24.pdf""")

    train_run("""-fullscreen ./train/25.pdf""")
