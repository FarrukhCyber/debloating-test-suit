...
def train():
    # 20
    train_run("""-antialias train/1.pdf""")

    train_run("""-antialias train/2.pdf""")

    train_run("""-antialias train/3.pdf""")

    train_run("""-antialias train/4.pdf""")

    train_run("""-antialias train/5.pdf""")

    train_run("""-antialias train/6.pdf""")

    train_run("""-antialias train/7.pdf""")

    train_run("""-antialias train/8.pdf""")

    train_run("""-antialias train/9.pdf""")

    train_run("""-antialias train/10.pdf""")

    train_run("""-antialias train/11.pdf""")

    train_run("""-antialias train/12.pdf""")

    train_run("""-antialias train/13.pdf""")

    train_run("""-antialias train/14.pdf""")

    train_run("""-antialias train/15.pdf""")

    train_run("""-antialias train/16.pdf""")

    train_run("""-antialias train/17.pdf""")

    train_run("""-antialias train/18.pdf""")

    train_run("""-antialias train/19.pdf""")

    train_run("""-antialias train/20.pdf""")

    train_run("""-antialias train/21.pdf""")

    train_run("""-antialias train/22.pdf""")

    train_run("""-antialias train/23.pdf""")

    train_run("""-antialias train/24.pdf""")

    train_run("""-antialias train/25.pdf""")
...
def main():
    ...
    if not os.path.exists("./logs"):
        ...
        cmd = "cp ../../../../tracebin/libcbr_indcall.so ./logs/"
        execute(cmd)
