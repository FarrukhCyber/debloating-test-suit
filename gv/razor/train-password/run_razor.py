...
def train():
    # 20
    train_run("""-password=123456 ./train/1.pdf""")

    train_run("""-password=111111 ./train/2.pdf""")

    train_run("""-password=222222 ./train/3.pdf""")

    train_run("""-password=333333 ./train/4.pdf""")

    train_run("""-password=aaaaaa ./train/5.pdf""")

    train_run("""-password=bbbbbb ./train/6.pdf""")

    train_run("""-password=cccccc ./train/7.pdf""")

    train_run("""-password=a1a2a3 ./train/8.pdf""")

    train_run("""-password=b1b2b3 ./train/9.pdf""")

    train_run("""-password=c1c2c3 ./train/10.pdf""")

    train_run("""-password=ffffff ./train/11.pdf""")

    train_run("""-password=ffffff ./train/12.pdf""")

    train_run("""-password=hellog ./train/13.pdf""")

    train_run("""-password=hellog ./train/14.pdf""")

    train_run("""-password=AAAAAA ./train/15.pdf""")

    train_run("""-password=AAAAAA ./train/16.pdf""")

    train_run("""-password=A1A1A1 ./train/17.pdf""")

    train_run("""-password=A1A1A1 ./train/18.pdf""")

    train_run("""-password=aA11bB ./train/19.pdf""")

    train_run("""-password=aA11bB ./train/20.pdf""")
